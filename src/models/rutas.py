...
class rutas(db.Model):
    ...
    def __init__(self, puntos,usuario,nombre_ruta,descripcion_ruta,longitud_latitud_inicial,longitud_latitud_final,fecha_creacion,duracion):
        self.puntos = puntos
...
class RutasSchema(ma.Schema):
    class Meta:
        fields = ('idruta', 'puntos','usuario','nombre_ruta','descripcion_ruta','longitud_latitud_inicial','longitud_latitud_final','fecha_creacion','duracion')